...
import 'package:social_clone/pages/homepage/views/comment_page.dart';
  ...
  fetchCommentLen() async {
    try {
      QuerySnapshot snap = await FirebaseFirestore.instance
          ...
          .collection('comments')
          .get();
      controller.commentLen.value = snap.docs.length;
    } catch (err) {
      showSnackBar(
        context,
        err.toString(),
                ...
                children: <Widget>[
                  ...
                  InkWell(
                    child: Container(
                      ...
                      child: Text(
                        'View all ${controller.commentLen.value} comments',
                        style: const TextStyle(
                          fontSize: 16,
